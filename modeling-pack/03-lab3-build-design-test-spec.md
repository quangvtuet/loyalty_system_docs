...
|---:|---|---|---|---|
| 1 | Message Broker - Apache Kafka | Dev / Ops | Edge & Ingestion Zone | `loyalty-platform-impl/docker-compose.yml` |
| 2 | Redis Cache & Distributed Lock | Dev / Ops | Data Services Zone | `loyalty-platform-impl/docker-compose.yml` |
...
| 8 | Earning Engine Service | Dev | Domain Services Zone | `loyalty-platform-impl/earning-engine/` |
| 9 | Tiering System Service | Dev | Domain Services Zone | `loyalty-platform-impl/tiering-system/` |
| 10 | Redemption Engine Service | Dev | Domain Services Zone | `loyalty-platform-impl/redemption-engine/` |
| 11 | Program Management Service | Dev | Domain Services Zone | `loyalty-platform-impl/program-management/` |
| 12 | Analytics & Reporting Service | Dev | Analytics Zone | `loyalty-platform-impl/analytics-reporting/` |
...
- `design/DD-03-redemption-engine.md`
- `loyalty-platform-impl/redemption-engine/`

## 3. To-Be Sequence: Redeem Reward with FIFO

Named use case: `UC-LB-02 Redeem reward with FIFO`.
...
| CON-R-004 | API Gateway / OAuth 2.0 Auth Server | Earning Engine Service | Sync | `POST /api/v1/partners/earn` | `loyalty-platform-impl/earning-engine` |
...
| CON-R-006 | Message Broker - Apache Kafka | Tiering System Service | Async | QP accrual consume | `loyalty-platform-impl/tiering-system` |
...
| CON-R-010 | API Gateway / OAuth 2.0 Auth Server | Redemption Engine Service | Sync | Redemption catalog/order APIs | `loyalty-platform-impl/redemption-engine` |
